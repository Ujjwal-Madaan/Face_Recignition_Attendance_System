...
class Student:
    def __init__(self, root, data=[str(i) for i in range(18)]):
        self.root = root
        ...
        main_frame.place(x=40, y=70, width=1570, height=800) #  width=1480    x=34
        ...
        Left_frame.place(x=10, y=10, width=770, height=777) #  width=700

        img_left = Image.open("Images/db2.png")
        img_left = img_left.resize((740, 145), Image.ANTIALIAS) # (700, 130)
        self.photoimg_left = ImageTk.PhotoImage(img_left)
        f_lbl = Label(Left_frame, image=self.photoimg_left)
        f_lbl.place(x=10, y=5, width=740, height=145) # width=680, hieght=130, x=5, y=0
        ...
        class_Student_frame.place(x=5, y=155, width=750, height=595) # width=680
        ...
        rollNum_label.place(x=10, y=20, anchor=NW)
        ...
        rollNum2_label.place(x=10, y=40, anchor=NW)
        ...
        # Adding 65 to 35 for dimensions
        ...
        name_text_label.place(x=150, y=100, anchor=NW)
        ...
        year_label.place(x=10, y=165, anchor=NW)
        ...
        year_text_label.place(x=150, y=165, anchor=NW)
        ...
        semester_label.place(x=10, y=230, anchor=NW)
        ...
        semester_text_label.place(x=150, y=230, anchor=NW)
        ...
        dep_label.place(x=10, y=295, anchor=NW) # y = 290
        ...
        dep_text_label.place(x=150, y=295, anchor=NW)
        ...
        phone_label.place(x=10, y=425, anchor=NW)
        ...
        phone_text_label.place(x=150, y=425, anchor=NW)
        ...
        email_label.place(x=10, y=490, anchor=NW)
        ...
        emailThapar_label.place(x=8, y=510, anchor=NW)
        ...
        email_text_label.place(x=150, y=500, anchor=NW)
        ...
        course_1_label.place(x=425, y=30, anchor=NW) # x=400
        ...
        course_1_text_label.place(x=585, y=30, anchor=NW) # x=560
        ...
        course_2_label.place(x=425, y=100, anchor=NW)
        ...
        course_2_text_label.place(x=585, y=100, anchor=NW)
        ...
        course_3_label.place(x=425, y=165, anchor=NW)
        ...
        course_3_text_label.place(x=585, y=165, anchor=NW)
        ...
        course_4_label.place(x=425, y=230, anchor=NW)
        ...
        course_4_text_label.place(x=585, y=230, anchor=NW)
        ...
        gender_label.place(x=425, y=295, anchor=NW)
        ...
        gender_text_label.place(x=585, y=295, anchor=NW)
        ...
        fatherNum_label.place(x=425, y=360, anchor=NW)
        ...
        father_text_label.place(x=585, y=360, anchor=NW)
        ...
        motherNum_label.place(x=425, y=425, anchor=NW)
        ...
        mother_text_label.place(x=585, y=425, anchor=NW)
        ...
        dob_label.place(x=425, y=490, anchor=NW)
        ...
        dob_label.place(x=425, y=510, anchor=NW)
        ...
        dob_text_label.place(x=585, y=500, anchor=NW)
        ...
        RollNum_label.place(x=185, y=23, anchor=NW)

        search_entry = ttk.Entry(
            Search_frame, width=14, font=("times new roman", 13, "bold")
        )
        search_entry.place(x=297, y=23, anchor=NW)
        ...
        search_btn.place(x=440, y=15, anchor=NW)
        ...
        self.student_table.column("Enroll no", width=150)
