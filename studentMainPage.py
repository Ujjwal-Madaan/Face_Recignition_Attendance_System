...
class studentMainPage:
    def __init__(self, root, data=None):
        ...
        details_frame.place(x=893, y=160, width=325, height=525)
        ...
        bg_img.place(x=451, y=183, width=290, height=290)
        # bg_img.place(x=373, y=183, width=300, height=300)

        # img3 = Details image
        img3 = Image.open("Images/studentDetails.jpeg")
        img3 = img3.resize((290, 290), Image.ANTIALIAS) # (300, 300)
        self.photoimg3 = ImageTk.PhotoImage(img3)
        bg_img = Label(self.root, image=self.photoimg3)
        bg_img.place(x=913, y=183, width=290, height=290)
        ...
        attendance_btn.place(x=31, y=351, anchor=NW)
