...
class forgotPassword:
    def __init__(self, root):
        ...
        login_frame.place(x=550, y=220, width=560, height=460) #(x=510, y=220, width=500, height=440)
        ...
        memType_combo.place(x=300, y=55, anchor=NW) #275
        ...
        email_entry.place(x=300, y=100, anchor=NW)
        ...
        otp_label.place(x=245, y=150, anchor=NW) #220
        ...
        otp_entry.place(x=300, y=150, anchor=NW)
        ...
        password_entry.place(x=300, y=200, anchor=NW)

        # password conditions
        passwordCondition1_label = Label(
            login_frame,
            text="• Should have at least one number",
            font=("times new roman", 11), #13
            bg="white",
        )
        ...
        password_entry.place(x=300, y=330, anchor=NW)
        ...
        if self.var_get_email.get() == "" or self.var_memType.get() == "":
            ...
            if len(my_email) > 0:
                if str(my_email[0][0]) == str(temp_email):
                    # Give OTP
                    admin_email = "codeindatabase@gmail.com"
                    admin_password = "1database1"

                    # Now wend the OTP

                    self.final_otp = np.random.randint(100000, 900000)
                    self.var_after_5_min = datetime.datetime.now() + datetime.timedelta(minutes=5)
                    ...
                    messagebox.showerror(
                        "Error",
                        "Invalid Email (Enter the registered thapar mail id",
                        parent=self.root,
                    )
            else:
                messagebox.showerror(
