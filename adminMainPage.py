...
class adminMainPage:
    def __init__(self, root):
        ...
        title_lbl.place(x=0, y=0, width=1650, height=50)

        # card 1
        # registerStudent frame
        registerStudent_frame = Frame(bg_img, bd=2, bg="white", highlightthickness=5)
        registerStudent_frame.place(x=30, y=70, width=300, height=385) #x=20, width=290
        ...
        img2 = img2.resize((235, 200), Image.ANTIALIAS)
        self.photoimg2 = ImageTk.PhotoImage(img2)
        student_img = Label(registerStudent_frame, image=self.photoimg2)
        student_img.place(x=25, y=17, width=235, height=200)
        ...
        registerStudent_btn.place(x=12, y=250, anchor=NW)

        # card 2
        # Register teacher frame
        registerTeacher_frame = Frame(bg_img, bd=2, bg="white", highlightthickness=5)
        registerTeacher_frame.place(x=460, y=70, width=300, height=385)
        ...
        img3 = img3.resize((240, 205), Image.ANTIALIAS)
        self.photoimg3 = ImageTk.PhotoImage(img3)
        teacher_img = Label(registerTeacher_frame, image=self.photoimg3)
        teacher_img.place(x=25, y=17, width=235, height=200)# (x=23, y=15, width=225, height=190)
        ...
        registerTeacher_btn.place(x=12, y=250, anchor=NW)
        ...
        checkStudentDetails_frame.place(x=890, y=70, width=300, height=385)
        ...
        img4 = img4.resize((265, 215), Image.ANTIALIAS)
        self.photoimg4 = ImageTk.PhotoImage(img4)
        checkStudentDetails_img = Label(checkStudentDetails_frame, image=self.photoimg4)
        checkStudentDetails_img.place(x=11, y=10, width=265, height=215)
        ...
        checkStudentDetails_btn.place(x=12, y=250, anchor=NW)
        ...
        checkTeacherDetails_frame.place(x=1320, y=70, width=300, height=385)
        ...
        img5 = img5.resize((265, 215), Image.ANTIALIAS)
        self.photoimg5 = ImageTk.PhotoImage(img5)
        checkTeacherDetails_img = Label(checkTeacherDetails_frame, image=self.photoimg5)
        checkTeacherDetails_img.place(x=11, y=10, width=265, height=215)
        ...
        checkTeacherDetails_btn.place(x=12, y=250, anchor=NW)

        # card 5
        # trainData frame
        trainData_frame = Frame(bg_img, bd=2, bg="white", highlightthickness=5)
        trainData_frame.place(x=245, y=485, width=300, height=385)
        ...
        img6 = img6.resize((265, 215), Image.ANTIALIAS)
        self.photoimg6 = ImageTk.PhotoImage(img6)
        trainData_img = Label(trainData_frame, image=self.photoimg6)
        trainData_img.place(x=11, y=10, width=265, height=215) #(x=10, y=10, width=255, height=200)
        ...
        trainData_btn.place(x=12, y=250, anchor=NW)

        # card 6
        # photos frame
        photos_frame = Frame(bg_img, bd=2, bg="white", highlightthickness=5)
        photos_frame.place(x=675, y=485, width=300, height=385)
        ...
        img7 = img7.resize((265, 215), Image.ANTIALIAS)
        self.photoimg7 = ImageTk.PhotoImage(img7)
        photos_img = Label(photos_frame, image=self.photoimg7)
        photos_img.place(x=11, y=10, width=265, height=215) #(x=10, y=10, width=255, height=200)
        ...
        photos_btn.place(x=12, y=250, anchor=NW)

        # card 7
        # checkAttendance frame
        checkAttendance_frame = Frame(bg_img, bd=2, bg="white", highlightthickness=5)
        checkAttendance_frame.place(x=1105, y=485, width=300, height=385)
        ...
        img8 = img8.resize((265, 215), Image.ANTIALIAS)
        self.photoimg8 = ImageTk.PhotoImage(img8)
        checkAttendance_img = Label(checkAttendance_frame, image=self.photoimg8)
        checkAttendance_img.place(x=11, y=10, width=265, height=215) #(x=10, y=10, width=255, height=200)
        ...
        checkAttendance_btn.place(x=12, y=250, anchor=NW)
