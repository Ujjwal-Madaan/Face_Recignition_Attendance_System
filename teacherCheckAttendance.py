...
class Student_attendance:
    def __init__(self, root, data=None):
        ...
        upper_frame.place(x=10, y=10, width=1550, height=265)

        # img2 = thapar logo
        img2 = Image.open("Images/db2.png")
        img2 = img2.resize((755, 235), Image.ANTIALIAS)
        self.photoimg2 = ImageTk.PhotoImage(img2)
        logo_img = Label(upper_frame, image=self.photoimg2)
        logo_img.place(x=775, y=-3, width=755, height=235)
        ...
        time_label.place(x=9, y=180, anchor=NW)
        ...
        timeFormat_label.place(x=11, y=205, anchor=NW)
        ...
        updateAttendance_btn.place(x=485, y=80)
        ...
        lower_frame.place(x=10, y=275, width=1550, height=515)
        ...
        Search_frame.place(x=5, y=1, width=1525, height=145)
        ...
        exportAll_btn.place(x=1230, y=17)

        # =========Table frame=================

        table_frame = Frame(lower_frame, bd=3, bg="white", relief=SUNKEN)
        table_frame.place(x=5, y=100, width=1525, height=380)
        # table_frame.place(x=5, y=100, width=1450, height=300)
        # Search_frame.place(x=5, y=5, width=1525, height=145)
