...
class studentRegister:
    def __init__(self, root):
        ...
        register_frame.place(x=350, y=130, width=935, height=700)
        ...
        title_lbl.place(x=350, y=105, width=935, height=42)
        ...
        rollNum_entry.place(x=230, y=30, anchor=NW)
        ...
        name_entry.place(x=230, y=90, anchor=NW)
        ...
        year_combo.place(x=230, y=150, anchor=NW)
        ...
        semester_combo.place(x=230, y=210, anchor=NW)
        ...
        dep_combo.place(x=230, y=270, anchor=NW)
        ...
        batch_combo.place(x=230, y=330, anchor=NW)
        ...
        email_entry.place(x=230, y=390, anchor=NW)

        # Phone no.
        phone_label = Label(
            register_frame,
            text="Phone No.",
            font=("times new roman", 14), #17
            bg="white",
        )
        ...
        phone_entry.place(x=230, y=450, anchor=NW)
        ...
        pass_entry.place(x=230, y=510, anchor=NW)
        ...
        course_1_label.place(x=520, y=30, anchor=NW)
        ...
        course_1_combo.place(x=705, y=30, anchor=NW)
        ...
        course_2_label.place(x=520, y=90, anchor=NW)
        ...
        course_2_combo.place(x=705, y=90, anchor=NW)
        ...
        course_3_label.place(x=520, y=150, anchor=NW)
        ...
        course_3_combo.place(x=705, y=150, anchor=NW)
        ...
        course_4_label.place(x=520, y=210, anchor=NW)
        ...
        course_4_combo.place(x=705, y=210, anchor=NW)
        ...
        gender_label.place(x=520, y=270, anchor=NW)
        ...
        gender_combo.place(x=705, y=270, anchor=NW)
        ...
        dob_label.place(x=520, y=332, anchor=NW)
        ...
        dob_btn.place(x=705, y=325, anchor=NW)
        ...
        fatherNum_label.place(x=520, y=390, anchor=NW)
        ...
        fatherNum_entry.place(x=705, y=390, anchor=NW)
        ...
        motherNum_label.place(x=520, y=450, anchor=NW)
        ...
        motherNum_entry.place(x=705, y=450, anchor=NW)
        ...
        confirmPass_label.place(x=520, y=510, anchor=NW)
        ...
        confirmPass_entry.place(x=705, y=510, anchor=NW)
        ...
        uploadPhoto_btn.place(x=230, y=570, anchor=NW)
    ...
    def add_data(
        ...
        if (
            ...
            or len(self.var_fatherNum.get())!=10
            or len(self.var_motherNum.get())!=10
        ):
            messagebox.showerror(
                "Error", "Phone Numbers should be of 10 digits", parent=self.root
            ) 
    ...
    def take_photo(self):
        if (
            ...
            cam = cv2.VideoCapture(0) # 0 to select the webcam for video capturing
            cam.set(3, 640)  # set video width = 3, 640 - resolution
