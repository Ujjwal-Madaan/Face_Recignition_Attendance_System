...
class Face_Recognition:
    def __init__(self, root, data):
        ...
        img1 = img1.resize((775, 855), Image.ANTIALIAS) # (675, 855)
        self.photoimg1 = ImageTk.PhotoImage(img1)
        bg_img = Label(self.root, image=self.photoimg1)
        bg_img.place(x=0, y=45, width=775, height=855)

        # right image
        img2 = Image.open("Images/face_recog.jpeg")
        img2 = img2.resize((875, 855), Image.ANTIALIAS) # (875, 855)
        self.photoimg2 = ImageTk.PhotoImage(img2)
        bg_img = Label(self.root, image=self.photoimg2)
        bg_img.place(x=775, y=45, width=875, height=855)
        ...
        b1_1.place(x=360, y=765, width=150, height=40)
